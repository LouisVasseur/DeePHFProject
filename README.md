...
python scripts/make_artifacts.py # please note that figures generated by this script will have different names than what is currently in figures/ due to a naming convention change
```
